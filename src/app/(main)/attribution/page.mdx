...
export const metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: `${OG_BASE_API_URL}?name=Attribution`,
                width: 800,
                height: 418,
            },
        ],
    ...
    twitter: {
        ...
        images: `${OG_BASE_API_URL}?name=Attribution`,
    },
};

# Attribution

I make this website (From scratch BTW) for improving my coding skills and practicing my English. Also for expressing my self.
...
- [Ritsuki](https://id.pinterest.com/pin/580190364524620952) melet.
